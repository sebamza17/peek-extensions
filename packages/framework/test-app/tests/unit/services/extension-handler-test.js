...
import { ExtensionDependencyType } from 'peek-extensions-framework-test/Extension';
import { WINDOW_SCRIPT_LOAD_EVENT } from 'peek-extensions-framework-test/services/extensions/extension-handler';
import ExtensionEventsService from 'peek-extensions-framework-test/services/extensions/extension-events';
import ExtensionsAPIService from 'peek-extensions-framework-test/services/extensions/extensions-api';
import ExtensionHandlerService from 'peek-extensions-framework-test/services/extensions/extension-handler';

// Create mock implementation
class MockExtensionHandlerService extends ExtensionHandlerService {
  dynamicallyImportLocalWebComponents(importObject) {
  ...
  dynamicallyImportLocalDependency(importObject) {
    return Promise.resolve({
      type: 'dependency',
      isMainScript: true,
      module: {
...
module('Unit | Service | extension-tests | extension handler', function (hooks) {
  ...
  hooks.beforeEach(function() {
    this.owner.register('service:extension-events', ExtensionEventsService);
    this.owner.register('service:extensions-api', ExtensionsAPIService);
    // Register our mock service
    this.owner.register('service:extensions/extension-handler', MockExtensionHandlerService);
  });
